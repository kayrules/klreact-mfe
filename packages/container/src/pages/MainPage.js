...
const HomeCarousel = Loadable({
  ...
  loading: () => (
    <MockComponent placeholder="Carousel" sx={{ height: "300px" }} />
  ),
});
      ...
      <Container maxWidth="xl" disableGutters sx={styles.content}>
        <Box sx={{ ...styles.loginContainer }}>
          <Box sx={styles.titleBox}>
            <Typography sx={styles.textTitle} fontWeight="fontWeightBold">
              Innovative Banking
            </Typography>
          </Box>
        ...
        <div
          ref={carouselRef}
          style={{ marginTop: "180px", ...carouselHeight }}
        >
...
const styles = {
  ...
  blueBox: {
    background:
      "green url(https://assets.imgix.net/examples/kingfisher.jpg?w=1611&h=500&crop=center&fit=crop) center",
